...
export default {
  ...
  props: {
    ...
    stdDev: {
      type: Number,
      default: 53.74011537017761
    },
    lowerBound: {
      type: Number,
      default: 22.52136858747795
    },
    upperBound: {
      type: Number,
      default: 171.47863141252205
    },
    max: {
      type: Number,
      default: 135.0
